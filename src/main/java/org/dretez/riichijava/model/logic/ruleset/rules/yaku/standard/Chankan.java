...
/**
 * Scored when "robbing a kan". When an opponent upgrades an open triplet into an added kan, you may call ron if the kan
 * would be your winning tile, scoring chankan in the process.
 */
